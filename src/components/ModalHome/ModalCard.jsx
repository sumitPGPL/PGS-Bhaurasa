  ...
  return (
    <>
      <div className="w-full h-full " >
        <h1 className='text-center p-3 text-tblue text-5xl font-extrabold'>Pratibha Global School, Bhaurasa</h1>
        <h2 className='text-center p-3 text-tblue text-3xl font-extrabold'>Admission Open 2024-25</h2>
