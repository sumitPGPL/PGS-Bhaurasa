...
export default function Career() {
    ...
    return (
        <div className="container mx-auto px-4">
            <div className="bg-cover h-96 bg-center bg-[url('/bgblue.svg')]">
            <h1 className='font-extrabold text-5xl text-black text-center py-8'>Careers</h1>
                ...
                <p className='font-bold text-4xl p-5 text-black text-center'><span className='text-transparent bg-clip-text bg-gradient-to-r to-[#43b4ed] from-blue-400'>Work Together&nbsp;</span>to Make Change ..!</p>
            </div>
                        ...
                        <div className="flex flex-col justify-between border-solid border-2 border-orange-100 p-10 shadow-2xl ">
                            <div className="flex justify-between items-center sm:flex justify-between items-center flex-wrap ">
                                ...
                                <div className='flex gap-5 '>
                                    <span className="bg-[#0e547e] rounded-full uppercase text-white text-sm px-4 py-1 font-bold shadow-xl max-w-full"> Remote </span>
                                    <span className="bg-[#0e547e] rounded-full uppercase text-white text-sm px-4 py-1 font-bold shadow-xl ">Full Time </span>
                                </div>
                            </div>
                            <div className="text-sm text-gray-500 flex space-x-1 items-center">
                                ...
                                <span className='flex my-5 flex-wrap'>
                                    {career.skills.map((skill, skillIndex) => (
                                        <div key={skillIndex} className="bg-blue-400 uppercase text-white text-sm px-4 py-1 font-bold shadow-xl">
                                            {skill}
                                        </div>
                                    ))}
                                </span>
