...
const Modal = ({ showModal, toggleModal }) => {
  ...
  <button type="submit" className="text-white justify-center flex items-center bg-yellow-500 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#43b4ed] dark:hover:bg-blue-700 dark:focus:ring-blue-800">
