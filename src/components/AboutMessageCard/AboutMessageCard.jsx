...
export default function AboutMessageCard({ img, heading, content }) {
    return (
            ...
            <div className='lg:w-3/12  w-full flex justify-center items-center py-2 '>
                <div className='lg:w-9/12  w-11/12 flex justify-center items-center'>
                    ...
                    alt="message"
                        ...
                        width="400"
                        height="550"
                        className='rounded-xl shadow-[3px_3px_2px_2px_#D8D8D8] border-2 border-[#43b4ed]'
                    />
                </div>
            </div>
            <div className='lg:w-9/12  w-full lg:pr-6 lg:pl-2 md:pl-2 p-0 flex flex-col items-start justify-start '>
                <h1 className='text-tblue text-lg font-semibold lg:py-2 lg:pr-5 p-2'>{heading}</h1>
