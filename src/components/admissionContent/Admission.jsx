...
const AdmissionForm = () => {
    ...
    const buttonData = [
        { name: 'Get in Touch', gradient: 'from-[#0e547e] via-[#43b4ed] to-[#0e547e]', textColor: 'text-white' },
        { name: 'Campus Visit', gradient: 'from-red-200 via-red-300 to-yellow-200', textColor: 'text-white' },
        { name: 'Application Form', gradient: 'from-[#0e547e] via-[#43b4ed] to-[#0e547e]', textColor: 'text-white' },
        { name: 'Submit Documents', gradient: 'from-[#0e547e] via-[#43b4ed] to-[#0e547e]', textColor: 'text-white' },
        { name: 'Receive Enrollment No', gradient: 'from-[#0e547e] via-[#43b4ed] to-[#0e547e]', textColor: 'text-white' },
        { name: 'Yay! center learning', gradient: 'from-[#0e547e] via-[#43b4ed] to-[#0e547e]', textColor: 'text-white' },
    ];
                    ...
                    <div className='flex flex-col md:flex-row md:justify-around items-center bg-cover'>
                        ...
                        <div className='flex flex-col justify-center items-center mt-5 md:mt-0 max-w-3xl'>
                            <h1 className="mb-4 text-center text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
                                <span className="text-transparent bg-clip-text bg-gradient-to-r to-[#43b4ed] from-blue-400">
                    ...
                    <div className='w-full bg-white py-10 bg-cover ' style={{ backgroundImage: "url('/Rect Light.svg')" }}>
                        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto'>
                            ...
                            <div className='flex flex-col justify-center gap-4 text-center'>
                                <p className='py-2 text-2xl text-[#1a9add] font-medium'>Admission</p>
                                <h1 className='md:leading-[72px] py-2 md:text-6xl text-4xl font-semibold'>Join Our Family  <span className='text-[#1a9add]'>of Young Learners </span>
                            ...
                            <div className="p-1.5 min-w-full inline-block align-middle">
                                <div className="overflow-hidden shadow-xl  rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200  dark:divide-gray-700 ">
                                        <thead>
                                            <tr>
                                                <th scope="col" className="bg-blue-400 px-6 py-3 text-center text-xs font-bold text-gray-100 uppercase">Programme</th>
                                                <th scope="col" className="bg-blue-400 px-6 py-3 text-center text-xs font-bold text-gray-100 uppercase">Age Group</th>
                                                <th scope="col" className="bg-blue-400 px-6 py-3 text-center text-xs font-bold text-gray-100 uppercase">Annual Tution</th>
                                            </tr>
                                        </thead>
                            ...
                            <div className="p-1.5 min-w-full inline-block align-middle">
                                <div className="overflow-hidden   shadow-xl rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200  dark:divide-gray-700">
                                        <thead>
                                            <tr>
                                                <th scope="col" className="bg-blue-400 px-6 py-3 text-center text-3xl font-medium text-gray-100 uppercase ">Additional Services</th>

                                                <th scope="col" className="bg-blue-400 px-6 py-3 text-center text-3xl font-medium text-gray-100 uppercase "></th>
                                            </tr>
                                        </thead>
