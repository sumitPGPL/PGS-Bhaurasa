...
const AccordionItem = ({ header, text }) => {
  ...
  return (
    <div className="mb-8 w-full  rounded-lg border-2 border-black  p-4  dark:bg-dark-2  sm:p-8 lg:px-6 md:px-8" style={{ backgroundColor: backgroundColor }} onClick={() => handleToggle()}>
      <button
