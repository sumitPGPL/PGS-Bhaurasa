...
<div className='w-full h-auto bg-white py-10 sm:bg-cover lg:bg-contain 'style={{ backgroundImage: "url('/Cloudy.svg')" }}>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto'>
            ...
            <div className='flex flex-col justify-start gap-4 text-center'>
                <p className='py-2 text-2xl text-[#1a9add] font-medium'>CONTACT US</p>
                <h1 className='md:leading-[72px] py-2 md:text-6xl text-4xl font-semibold'>Feel Free   <span className='text-[#1a9add]'><br></br>To </span> <span  className='text-[#1a9add]'><br></br>Connect</span>  With Us 
		...
		<div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
            ...
            type="number" placeholder="Phone*" />
				...
				<div className="my-2 w-1/2 lg:w-1/4">
					<button onClick={handleSubmit} className="uppercase text-sm font-bold tracking-wide hover:bg-[#0e547e] active:bg-blue-800 bg-blue-400 text-gray-100 p-3 rounded-lg w-full 
