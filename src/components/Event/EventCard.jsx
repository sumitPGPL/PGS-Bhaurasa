...
const EventCard = ({ eventDetails }) => {
    ...
    return (
        <>
            <div className='group w-full md:h-52 lg:h-52 sm:h-48 h-44 border-2 border-gray-300 rounded-2xl flex justify-around items-center p-2 md:p-4 sm:p-2 lg:p-4 hover:bg-[#0e547e] hover:text-white'>
