    ...
    <div className='  w-full h-full bg-contain bg-center bg-none' > {/* Main container */}
      <div className='w-full bg-white py-10 bg-cover ' style={{ backgroundImage: "url('/Cloudy.svg')" }}>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto'>
          ...
          <div className='flex flex-col justify-start gap-4 text-center'>
            <p className='py-2 text-2xl text-[#1a9add] font-medium'>START TO SUCCESS</p>
            <h1 className=' py-2 md:text-6xl text-4xl font-semibold'>Welcome to    <span className='text-[#1a9add]'>PGS</span> <span className='text-[#1a9add]'>Learners</span> Academy
      ...
      <div className="">
        ...
        <div className="pt-6 md:p-8 text-center md:text-middle space-y-4 mb-5">
          <blockquote>
            {/* Quote */}
            <p className="text-4xl pt-2 font-bold bg-clip-text text-gradient-to-r from-blue-400 to-pink-600">
          ...
          <figcaption className="font-medium">
            ...
            {/* Buttons */}
            <div>
              <Button className="bg-[#0e547e] p-3 rounded mr-6"><Link href="/admissions">Enquire Now</Link></Button>
        ...
        <div className="flex flex-wrap justify-center gap-5 lg:px-10 md:px-2">
          {/* Vision */}
          <div href="#" className="text-center block max-w-xl p-5 bg-white border border-gray-200 shadow-[5px_5px_0px_0px_rgba(76,175,80)] rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" style={{ backgroundImage: "" }}>
          ...
          {/* Mission */}
          <div href="#" className="text-center block max-w-xl p-5 bg-white border shadow-[5px_5px_0px_0px_rgba(76,175,80)] border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" style={{ backgroundImage: "" }}>
        ...
        {/* Section: Philosophy */}
        <div className="my-10 " style={{ background: '[#43b4ed]' }}>
          {/* Image */}
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-5 mx-5">
            {cards.map((card, index) => (
              <div key={index} className="p-[20px] bg-white rounded-xl shadow-[#43b4ed] border-gray-200 rounded-lg shadow flex-col justify-start items-start gap-[30px] inline-flex">
                ...
                <div className="self-stretch p-[20px] bg-blue-100 rounded-xl shadow-lg flex-col justify-start items-start gap-5 flex">
