        ...
        <div className='bg-gradient-to-r from-pink-300 to-indigo-200 rounded-lg m-10 p-16'>
          ...
          <div className='flex justify-center pl-10'>
            ...
            <ol className="flex items-center w-96 ">
              <li className="flex w-full items-center justify-center text-[#43b4ed] dark:text-blue-500 after:content-[''] after:w-full after:h-1 after:border-b after:border-blue-100 after:border-4 after:inline-block dark:after:border-blue-800 ">
                <span className="flex items-center justify-center w-10 h-10 bg-blue-100 rounded-full lg:h-12 lg:w-12 dark:bg-blue-800 shrink-0">
                  <svg className="w-3.5 h-3.5 text-[#43b4ed] lg:w-4 lg:h-4 dark:text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
