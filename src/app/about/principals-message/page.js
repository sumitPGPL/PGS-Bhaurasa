...
export default function page() {
    ...
    return (
        <>
            <main className="min-h-full flex flex-col p-5  justify-center items-center dark:bg-dblue bg-[url('/MessageSvg.svg')]">
                ...
                <div className="full flex flex-col justify-center items-center mt-9">
                    ...
                    <AboutMessageCard
                        ...
                        heading="Mrs. Sapna Jain, Principal (Pratibha Global School, Bhaurasa)"
