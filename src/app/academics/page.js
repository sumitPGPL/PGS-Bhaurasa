  ...
  return (
    <>
      <main className=" flex flex-col justify-center items-center mt-5">
        <div className='w-11/12 flex justify-center  p-5 rounded-3xl sm:border-2 sm:1/2 mt-8' style={{ backgroundImage: "url('/bgblue.svg')",backgroundRepeat:"no-repeat", backgroundPosition:"center" , backgroundSize:"cover"}}>

          <div className="w-full p-4 relative">
            <h1 className='text-4xl text-black font-bold  mb-10 text-shadow-md'>Nurturing Young Minds For  Success</h1>
            <h6 className='text-1xl text-black'>Welcome to our Academics page, where we take pride in providing a comprehensive and stimulating educational experience for your child. Our kindergarten school's academic program is thoughtfully designed to foster a love for learning while building a strong foundation of essential skills and knowledge. From language arts and mathematics to science and social studies, our curriculum is carefully crafted to spark curiosity and encourage active exploration.</h6>

          

            <div className="flex space-x-4 mt-20">

              <button className="bg-white hover:bg-gray-300 text-blue-400 font-bold py-2 px-4 rounded " onClick={() => { router.push('/admissions') }}>
                Admission Form
              </button>
              <button className="bg-white hover:bg-gray-300 text-blue-400  font-bold py-2 px-4 rounded " onClick={() => { router.push('/contact-us') }}>
                Contact
              </button>
            </div>
      ...
      <div className='min-h-100 p-10 flex justify-center items-center flex-col mt-12'>
        <h1 className=' text-white text-2xl font-solid flex justify-center   bg-blue-400 rounded-xl p-2
           ' >Our Feature</h1>
        <h2 className='md:text-5xl lg:text-5xl sm:text-5xl font-black flex justify-center p-15 pb-2
          mt-6 '>Our Special Feature</h2>
        <p className='md:w-3/4 lg:w-3/4  sm:w-full flex justify-center font-dancing-script text-center mt-3'>Our kinder garden school provides a nurturing and stimulating environment, fostering a love for learning that lasts a lifetime. Join us as we embark on an exciting educational journey together!
        </p>
          ...
          {[
            {
              ...
              paragraph: "Our curriculum is centered around engaging themes that capture children's imaginations. Each theme integrates multiple subjects, making learning enjoyable and relevant"
            },
            {
              svgLink: "/feature.svg",
              heading: "STEAM Education",
              paragraph: "We offer innovative STEAM (Science, Technology, Engineering, Arts, and Mathematics) programs that promote hands-on exploration, critical thinking, and problem-solving skills"
            },
            {
              svgLink: "/feature.svg",
              heading: "Language Immersion",
              paragraph: "Through language immersion programs, children have the opportunity to learn a second language, enhancing cognitive development and global awareness"
            },
            {
              svgLink: "/feature.svg",
              heading: "Art and Creativity",
              paragraph: "Art is celebrated at Little Learners Academy. Our art-focused activities encourage self-expression, creativity, and the appreciation of various art forms"
            },
            {
              svgLink: "/feature.svg",
              heading: "Outdoor Education",
              paragraph: "Play is an integral part of early childhood education. Our play-based approach enhances social skills, emotional development, and imaginative thinking"
            },
            {
              svgLink: "/feature.svg",
      ...
      <div className='min-h-100 p-10 flex justify-center items-center flex-col mt-4'>
        <h1 className=' text-white text-2xl font-solid flex justify-center   bg-blue-400 rounded-xl p-2
           '>Our Feature</h1>
        <h2 className='md:text-5xl lg:text-5xl sm:text-5xl font-black flex justify-center p-15 pb-2
          mt-4 '>Our Rooms Gallary</h2>
        <p className='md:w-3/4 lg:w-3/4  sm:w-full flex justify-center font-dancing-script text-center mt-3'>Step into our Gallery and immerse yourself in a visual journey of cherished moments and unforgettable experiences at our kindergarten school.
        </p>
