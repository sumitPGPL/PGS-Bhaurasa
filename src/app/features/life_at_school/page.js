    ...
    <>
      <main className=" w-full flex flex-col justify-center  p-5  bg-cover bg-center" style={{ backgroundImage: "url('/MessageSvg.svg')" }}>
        <div className='w-11/12 mx-auto h-80 flex justify-center items-center rounded-lg bg-cover bg-center' style={{ backgroundImage: "url('https://images.pexels.com/photos/743986/pexels-photo-743986.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')" }}>
          <h1 className="text-5xl text-[#43b4ed] font-extrabold dark:text-white text-center p-5">Life At <small className="ms-2 font-semibold text-gray-500 dark:text-gray-400">School</small></h1>
        </div>
        ...
        <h1 className="text-5xl text-[#43b4ed] font-extrabold dark:text-white text-center p-5">Life At <small className="ms-2 font-semibold text-gray-500 dark:text-black-400">School</small></h1>
