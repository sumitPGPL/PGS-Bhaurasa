        ...
        <>
            ...
            <main className='w-full flex flex-col justify-center items-center'>
                <div className=' flex justify-between border-2  '>
                    ...
                    <button className='bg-blue-400 border-2 p-4  text-white text-lg' onClick={() => { setResourceType('posts') }}>WholeSales</button>
                    <button className='bg-blue-400 border-2 p-4 text-white text-lg' onClick={() => { setResourceType('Users') }}>Retailes</button>
                    <button className='bg-blue-400 border-2 p-4 text-white text-lg' onClick={() => { setResourceType('Comments') }}>Agents</button>
                </div>
                        ...
                        <div className="p-1.5 min-w-full inline-block align-middle">
                            <div className="overflow-hidden shadow-xl  rounded-lg">
                                <table className="min-w-full divide-y divide-gray-200  dark:divide-gray-700 ">
                                    <thead>
                                        <tr className='w-full bg-blue-400 px-6 py-3 text-center text-lg font-bold text-gray-100 '>
                                            Wholesales
                                        </tr>
                                        <tr>
                                            <th scope="col" className="bg-blue-400 px-6 py-3 text-center text-lg font-bold text-gray-100 ">Name</th>
                                            <th scope="col" className="bg-blue-400 px-6 py-3 text-center text-lg font-bold text-gray-100 uppercase">Describtion</th>
                                            <th scope="col" className="bg-blue-400 px-6 py-3 text-center text-lg font-bold text-gray-100 uppercase">Privileges</th>
                                            <th scope="col" className="bg-blue-400 px-6 py-3 text-center text-lg font-bold text-gray-100 uppercase">Notification</th>
                                        </tr>
                                    </thead>
                ...
                <form className='w-10/12 mx-auto  '>
                   ...
                   <h1 className='text-lg'>previllage</h1>
                    ...
                    <button type="submit" className="bg-blue-400 w-full text-white px-4 py-2 rounded-md">save</button>
                </form>
